...
<body>
    ...
    <form action="register.php" method="post">
        ...
        <?php
            if (in_array("Email or password was incorrect<br>",$errors_array)) echo "Email or password is incorrect<br>";
        ?>
        <br>
    </form>
    <form action="register.php" method="post">
        ...
        <br>
        <?php 
            if(in_array("Your First Name must be between 2 and 25 chracters <br>",$errors_array)) echo "Your First Name must be between 2 and 25 chracters <br>";
        ?>
        ...
        <br>
        <?php 
            if(in_array("Your Middle Name must be between 2 and 25 chracters <br>",$errors_array)) echo "Your Middle Name must be between 2 and 25 chracters <br>";
        ?>
        ...
        <br>
        <?php 
            if(in_array("Your Last Name must be between 2 and 25 chracters <br>",$errors_array)) echo "Your Last Name must be between 2 and 25 chracters <br>";
        ?>
